...
sleep 3
wget https://raw.githubusercontent.com/ff0255/PiNodeXMR/testrig/etc/sudoers -O /home/pinodexmr/sudoers
...
git clone --single-branch -b testrig https://github.com/ff0255/PiNodeXMR.git 2>&1 | tee -a /home/pinodexmr/debug.log
				...
				#Backup User values
					...
					mv /home/pinodexmr/variables/mining-threads.sh /home/pinodexmr/variables/mining-threads_retain.sh 2> >(tee -a /home/pinodexmr/debug.log >&2)
		...
		#Install Update
			...
			sleep 2
				...
				#Attempt update of tor hidden service settings
					...
					sleep 6
					sudo wget https://raw.githubusercontent.com/ff0255/PiNodeXMR/testrig/etc/tor/torrc -O /etc/tor/torrc 2> >(tee -a /home/pinodexmr/debug.log >&2)
				...
				echo "Update PiNodeXMR version number" >>/home/pinodexmr/debug.log
					wget https://raw.githubusercontent.com/ff0255/PiNodeXMR/testrig/new-ver-pi.sh -O /home/pinodexmr/new-ver-pi.sh 2> >(tee -a /home/pinodexmr/debug.log >&2)
